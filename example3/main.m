...
alpha = 0.95; % Fractional derivative order
k = 4; % Number of states to predict simultaneously
T = 160; % Total prediction time length
N = 1600; % Total number of prediction time steps
